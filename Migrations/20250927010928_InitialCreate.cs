    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, "Lima", "DEP-001", "Av. Principal 123", 3, null, 85, 120000m, "Departamento", "Departamento céntrico" },
                    { 2, true, 3, "Arequipa", "CAS-002", "Calle Los Olivos 456", 4, null, 150, 250000m, "Casa", "Casa con jardín" },
                    { 3, true, 1, "Cusco", "OFI-003", "Jr. Comercio 789", 0, null, 60, 95000m, "Oficina", "Oficina moderna" }
                });
